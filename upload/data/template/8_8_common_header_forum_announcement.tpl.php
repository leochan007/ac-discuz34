...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1542087189, '8', './data/template/8_8_common_header_forum_announcement.tpl.php', './template/lanmeng_sjyd', 'common/header_forum_announcement')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1542087189, '8', './data/template/8_8_common_header_forum_announcement.tpl.php', './template/lanmeng_sjyd', 'common/header_forum_announcement')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1542087189, '8', './data/template/8_8_common_header_forum_announcement.tpl.php', './template/lanmeng_sjyd', 'common/header_forum_announcement')
;?>

...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1542087246, '8', './data/template/8_8_forum_forumdisplay_fastpost.tpl.php', './template/lanmeng_sjyd', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1542087246, '8', './data/template/8_8_forum_forumdisplay_fastpost.tpl.php', './template/lanmeng_sjyd', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1542087246, '8', './data/template/8_8_forum_forumdisplay_fastpost.tpl.php', './template/lanmeng_sjyd', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1542087246, '8', './data/template/8_8_forum_forumdisplay_fastpost.tpl.php', './template/lanmeng_sjyd', 'forum/forumdisplay_fastpost')
;?>

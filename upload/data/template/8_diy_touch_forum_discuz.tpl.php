...
<div class="wp wm" id="wp"><?php if(is_array($catlist)) foreach($catlist as $key => $cat) { ?><div class="bm bmw fl lmkj_forum">
<div class="subforumshow bm_h cl" href="#sub_forum_<?php echo $cat['fid'];?>">
<span class="o"><img src="<?php echo $_G['siteurl'];?>template/lanmeng_sjyd/touch/images/collapsed_<?php if(!$_G['setting']['mobile']['mobileforumview']) { ?>yes<?php } else { ?>no<?php } ?>.png"></span>
...
obj.find('img').attr('src', '<?php echo $_G['siteurl'];?>template/lanmeng_sjyd/touch/images/collapsed_yes.png');
} else {
subobj.css('display', 'none');
obj.find('img').attr('src', '<?php echo $_G['siteurl'];?>template/lanmeng_sjyd/touch/images/collapsed_no.png');
}
});
 })();
</script>

...
<div class="wp wm" id="wp">
	...
	<div class="bm bmw fl lmkj_forum">
		<div class="subforumshow bm_h cl" href="#sub_forum_$cat[fid]">
			<span class="o"><img src="{$_G['siteurl']}template/lanmeng_sjyd/touch/images/collapsed_<!--{if !$_G[setting][mobile][mobileforumview]}-->yes<!--{else}-->no<!--{/if}-->.png"></span>
	...
	(function() {
		...
		$('.subforumshow').on('click', function() {
			...
			if(subobj.css('display') == 'none') {
				...
				obj.find('img').attr('src', '{$_G['siteurl']}template/lanmeng_sjyd/touch/images/collapsed_yes.png');
			} else {
				subobj.css('display', 'none');
				obj.find('img').attr('src', '{$_G['siteurl']}template/lanmeng_sjyd/touch/images/collapsed_no.png');
			}
		});
	 })();
</script>
